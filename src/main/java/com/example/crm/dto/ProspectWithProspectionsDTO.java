...
public class ProspectWithProspectionsDTO {
    private Long id;
    private String name;
    ...
    private List<ProspectionDTO> prospections;
    ...
    public List<ProspectionDTO> getProspections() { return prospections; }
    public void setProspections(List<ProspectionDTO> prospections) { this.prospections = prospections; }
}